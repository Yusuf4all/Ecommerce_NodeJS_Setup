...
const SLOT_SCHEMA = new mongoose.Schema({
    ...
    Is_Home_Available: { type: Boolean, default: false },
    Is_Office_Available: { type: Boolean, default: false },
    Travel_Time: { type: Boolean, default: false },
    Slot_Type: { type: String, default: null },
    Slot_No: { type: Number }
})
...
module.exports = mongoose.model('availability_two', AVAILABILITY_SCHEMA);